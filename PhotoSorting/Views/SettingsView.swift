        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("Лёгкая тактильная отдача при свайпе и завершении сессии.")
                }
            ...
            .alert("Сбросить все данные?", isPresented: $showResetConfirmation) {
                ...
                Text("Это действие нельзя отменить. Серия дней, счётчики и история обработанных фото будут удалены.")
            }
        }
    }
